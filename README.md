...
├── main.py                           # Master build - entry point
└── README.md
```
...
```bash
python main.py test_root=C          # build only the "C" root
python main.py --errors             # also print each failure's error text (dimmed) in the console
python main.py test_root=asm --errors
```
